...
import { ChangeCompanyDialog } from "./change-company-dialog"
...
export function Layout({ children }: LayoutProps) {
    ...
    return (
        <>
                        ...
                        <div className="w-full flex-1 items-end flex justify-end gap-4">
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                    ...
                                    <DropdownMenuItem onClick={handleOpenCompanyDialog}>Alterar empresa</DropdownMenuItem>
                                    <DropdownMenuSeparator />
            ...
            <ChangeCompanyDialog open={selectCompanyDialog} setOpen={setSelectCompanyDialog} />
        </>
